...
// let estoqueBaixo = produtos.filter(produto => 
//   produto.estoque < 50 &&
//   produto.curva_abc === "A" &&
//   produto.rotatividade === "alta"
// );
  
// let custoEstoque = produtos.reduce((acumulador, produto) => acumulador + (produto.preco_compra * produto.estoque), 0 );


// let vendaTotal = produtos.reduce((acumulador, produto) => acumulador + (produto.preco_venda * produto.estoque), 0)
// let EstoqueTotal = produtos.reduce((acumulador, produto) => acumulador + (produto.estoque), 0)
...
// let estoquefind = produtos.find(produto => produto.id == 22);
